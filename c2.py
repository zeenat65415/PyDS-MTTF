class Cat:
    #constructor 
    def _init_(self,name,age,breed):#self refers to the class itself .it is a keyword like this in java. _init_ is aconstructor.In java constructor name is same as class name.
        #pass
